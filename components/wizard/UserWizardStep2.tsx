...
interface UserWizardStep2Props {
  onNext: () => void
  onPrev: () => void
}

export default function UserWizardStep2({ onNext, onPrev }: UserWizardStep2Props) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-bold">관심사. 평소 관심이 있었던 활동들을 골라주세요.</h2>
